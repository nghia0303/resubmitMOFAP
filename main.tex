...
\midrule
\textit{Step 4} & Set $K\leftarrow UB-1$ and build the selected objective encoding for the At-Most-$K$ constraint: \texttt{ITotalizer} for INC or Sequential Counter~\eqref{eq:nsc_1}--\eqref{eq:nsc_7} for INCSC. \\
\midrule
